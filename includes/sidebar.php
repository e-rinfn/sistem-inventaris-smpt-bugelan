...
<aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
  ...
  <ul class="menu-inner py-1">
    ...
    <li class="menu-item <?= isActive('/dashboard') ?>">
      <a href="<?= $base_url ?>/dashboard/index.php" class="menu-link">
    ...
    <li class="menu-item <?= isActive('/barang') ?>">
      <a href="<?= $base_url ?>/barang/index.php" class="menu-link">
    ...
    <li class="menu-item">
      ...
      <ul class="menu-sub">
        <li class="menu-item <?= isActive('/kategori') ?>">
          <a href="<?= $base_url ?>/kategori/index.php" class="menu-link">
            <div data-i18n="Without navbar">Kategori</div>
          </a>
        </li>
        <li class="menu-item <?= isActive('/lokasi') ?>">
          <a href="<?= $base_url ?>/lokasi/index.php" class="menu-link">
            <div data-i18n="Without menu">Lokasi</div>
          </a>
        </li>
        <li class="menu-item <?= isActive('/supplier') ?>">
          <a href="<?= $base_url ?>/supplier/index.php" class="menu-link">
    ...
    <li class="menu-item <?= isActive('/transaksi/masuk') ?>">
      <a href="<?= $base_url ?>/transaksi/masuk" class="menu-link">
    ...
    <li class="menu-item <?= isActive('/transaksi/keluar') ?>">
      <a href="<?= $base_url ?>/transaksi/keluar" class="menu-link">
    ...
    <li class="menu-item <?= isActive('/transaksi/hilang') ?>">
      <a href="<?= $base_url ?>/transaksi/hilang" class="menu-link">
    ...
    <li class="menu-item">
      ...
      <ul class="menu-sub">
        <li class="menu-item <?= isActive('/laporan/stok.php') ?>">
          <a href="<?= $base_url ?>/laporan/stok.php" class="menu-link">
            <div data-i18n="Without navbar">Stok Barang</div>
          </a>
        </li>
        <li class="menu-item <?= isActive('/laporan/transaksi.php') ?>">
          <a href="<?= $base_url ?>/laporan/transaksi.php" class="menu-link">
    ...
    <li class="menu-item <?= isActive('/pages/panduan') ?>">
      <a href="<?= $base_url ?>/panduan/index.php" class="menu-link">
